This file is the baseline code for TensorFlow - HuBMAP - Hacking the Kidney--Identify glomeruli in human kidney tissue images

以上文件是HuBMAP - Hacking the Kidney--Identify glomeruli in human kidney tissue images（入侵肾脏检测大赛）比赛的baseline代码
